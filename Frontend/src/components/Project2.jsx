    ...
    <section className="w-full bg-[#f5f5f3] py-16 md:py-24 px-5 sm:px-8 md:px-16 overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative h-[420px] sm:h-[520px] lg:h-[650px] w-full order-2 lg:order-1"
        >
          {/* Main Image */}
          <div className="absolute left-0 top-0 w-[78%] sm:w-[72%] h-[300px] sm:h-[420px] lg:h-[520px] overflow-hidden shadow-2xl rounded-sm">
            <img
              src="/images/j1.jpeg"
              alt="Marble Design"
          ...
          <div className="absolute right-0 bottom-0 w-[55%] sm:w-[48%] h-[180px] sm:h-[240px] lg:h-[280px] overflow-hidden shadow-xl border-4 sm:border-8 border-[#f5f5f3] rounded-sm">
            <img
              src="/images/j2.jpeg"
          ...
          {/* Decorative Borders */}
          <div className="absolute top-8 sm:top-12 -left-4 sm:-left-6 w-20 sm:w-32 h-20 sm:h-32 border border-gray-300 -z-10"></div>

          <div className="absolute bottom-6 right-8 sm:right-12 w-16 sm:w-24 h-16 sm:h-24 border border-gray-300 -z-10"></div>
        </motion.div>
